...
const allTools: Tool[] = [
  ...
  { icon: IconArrowsLeftRight, colour: '#D68A1B', label: 'Test swap', sub: 'Swap test dates', route: '/test-swap', group: 'Teaching' },
                ...
                <div style={{ margin: '16px 16px 0' }}>
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ fontSize: 14, color: '#8592A6', marginTop: 2 }}>
