...
const allTools: Tool[] = [
  // Teaching
  { icon: BookOpen, colour: '#1877D6', label: 'EOL Wizard', sub: 'End of lesson', route: '/eol', group: 'Teaching' },
  { icon: RefreshCw, colour: '#1877D6', label: 'Recurring lessons', sub: 'Weekly series', route: '/lesson-series', group: 'Teaching' },
  ...
  { icon: FileText, colour: '#1877D6', label: 'Invoices', sub: 'Billing', route: '/invoices', group: 'Business' },
  { icon: MapPin, colour: '#1877D6', label: 'Coverage areas', sub: 'Service areas', route: '/coverage-areas', group: 'Business' },
  // Admin
  { icon: Settings, colour: '#6B7280', label: 'Settings', sub: 'Account settings', route: '/settings', group: 'Admin' },
  { icon: Clock, colour: '#1877D6', label: 'Availability', sub: 'Working hours', route: '/availability-settings', group: 'Admin' },
  { icon: Calendar, colour: '#1877D6', label: 'Calendar sync', sub: 'Google Calendar', route: '/calendarsync', group: 'Admin' },
  ...
  // Reports
  { icon: BarChart3, colour: '#1877D6', label: 'MTD', sub: 'Month to date', route: '/mtd', group: 'Reports' },
  ...
  { icon: ShoppingBag, colour: '#1877D6', label: 'Marketplace', sub: 'Products & services', route: '/marketplace', group: 'Community' },
