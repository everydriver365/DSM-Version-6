...
function FeatureSection({
  ...
  return (
    <section className="py-20 px-6" style={{ background: bg, fontFamily: "Poppins, sans-serif" }}>
...
function FeaturesPage() {
  return (
    <div style={{ fontFamily: "Poppins, sans-serif" }}>
      ...
      <section className="bg-[#133155] py-20 px-6 text-center" style={{ fontFamily: "Poppins, sans-serif" }}>
        <div className="max-w-[1180px] mx-auto">
