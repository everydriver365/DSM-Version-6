...
function ResetPasswordPage() {
  ...
  const inputCls =
    "h-12 w-full rounded-lg px-3 pr-10 text-[14px] text-[#0C2340] bg-white placeholder:text-[#9CA3AF] focus:outline-none focus:border-[#1A4A6E]";
      ...
      >
        {done ? (
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="text-[20px] font-semibold text-[#0C2340]">Password updated!</h2>
            <p className="text-[13px] text-[#6B7280] mt-2">Redirecting to sign in…</p>
          </div>
        ) : (
          <form onSubmit={onSubmit} className="flex flex-col">
            <h2 className="text-[20px] font-semibold text-[#0C2340] text-center mb-6">New password</h2>
