...
const quickAccessTiles = [
  { icon: <CalendarIcon size={22} color="#FFFFFF" />, bg: "#1A4A6E", label: "Schedule", route: "/schedule" },
  ...
  { icon: <MessageSquare size={22} color="#FFFFFF" />, bg: "#1A4A6E", label: "Messages", route: "/messages" },
  ...
  { icon: <BarChart2 size={22} color="#FFFFFF" />, bg: "#1A4A6E", label: "Reports", route: "/reports" },
  ...
  { icon: <Inbox size={22} color="#FFFFFF" />, bg: "#1A4A6E", label: "Enquiries", route: "/enquiries" },
  ...
  { icon: <BookOpen size={22} color="#FFFFFF" />, bg: "#1A4A6E", label: "CPD", route: "/cpd" },
  ...
  { icon: <FolderOpen size={22} color="#FFFFFF" />, bg: "#1A4A6E", label: "Documents", route: "/documents" },
  ...
  { icon: <Search size={22} color="#FFFFFF" />, bg: "#1A4A6E", label: "Find gaps", route: "/gaps" },
  ...
  { icon: <BarChart2 size={22} color="#FFFFFF" />, bg: "#1A4A6E", label: "Weekly report", route: "/weeklyreport" },
  ...
  { icon: <ToggleLeft size={22} color="#FFFFFF" />, bg: "#1A4A6E", label: "Availability", route: "/availability" },
  ...
  { icon: <CalendarDays size={22} color="#FFFFFF" />, bg: "#1A4A6E", label: "Diary", route: "/diary" },
  ...
  { icon: <CalendarDays size={22} color="#FFFFFF" />, bg: "#1A4A6E", label: "Availability", route: "/quickavailability" },
  { icon: <RefreshCw size={22} color="#FFFFFF" />, bg: "#7C3AED", label: "Calendar sync", route: "/calendarsync" },
  { icon: <UserCircle size={22} color="#FFFFFF" />, bg: "#1A4A6E", label: "Profile", route: "/profile" },
        ...
        <div className="px-4 pt-3 pb-1">
          ...
          >
            ...
            <input
              ...
              className="flex-1 bg-transparent outline-none text-[14px] text-[#0C2340] placeholder-[#9CA3AF]"
              autoFocus
            />
            {searchQuery && (
              <button
