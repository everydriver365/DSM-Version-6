...
const quickAccessTiles = [
  { icon: <CalendarIcon size={22} color="#FFFFFF" />, bg: "#0B7DDA", label: "Schedule", route: "/schedule" },
  ...
  { icon: <MessageSquare size={22} color="#FFFFFF" />, bg: "#0B7DDA", label: "Messages", route: "/messages" },
  ...
  { icon: <BarChart2 size={22} color="#FFFFFF" />, bg: "#0B7DDA", label: "Reports", route: "/reports" },
  ...
  { icon: <Inbox size={22} color="#FFFFFF" />, bg: "#0B7DDA", label: "Enquiries", route: "/enquiries" },
  ...
  { icon: <BookOpen size={22} color="#FFFFFF" />, bg: "#0B7DDA", label: "CPD", route: "/cpd" },
  ...
  { icon: <FolderOpen size={22} color="#FFFFFF" />, bg: "#0B7DDA", label: "Documents", route: "/documents" },
  ...
  { icon: <Search size={22} color="#FFFFFF" />, bg: "#0B7DDA", label: "Find gaps", route: "/gaps" },
  ...
  { icon: <BarChart2 size={22} color="#FFFFFF" />, bg: "#0B7DDA", label: "Weekly report", route: "/weeklyreport" },
  ...
  { icon: <ToggleLeft size={22} color="#FFFFFF" />, bg: "#0B7DDA", label: "Availability", route: "/availability" },
  ...
  { icon: <CalendarDays size={22} color="#FFFFFF" />, bg: "#0B7DDA", label: "Diary", route: "/diary" },
  ...
  { icon: <CalendarDays size={22} color="#FFFFFF" />, bg: "#0B7DDA", label: "Availability", route: "/quickavailability" },
  { icon: <RefreshCw size={22} color="#FFFFFF" />, bg: "#7C3AED", label: "Calendar sync", route: "/calendarsync" },
  { icon: <UserCircle size={22} color="#FFFFFF" />, bg: "#0B7DDA", label: "Profile", route: "/profile" },
