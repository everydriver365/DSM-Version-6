...
const quickAccessTiles = [
  { icon: <CalendarIcon size={22} color="#FFFFFF" />, bg: "#1A52A0", label: "Schedule", route: "/schedule" },
  ...
  { icon: <MessageSquare size={22} color="#FFFFFF" />, bg: "#1A52A0", label: "Messages", route: "/messages" },
  ...
  { icon: <BarChart2 size={22} color="#FFFFFF" />, bg: "#1A52A0", label: "Reports", route: "/reports" },
  ...
  { icon: <Inbox size={22} color="#FFFFFF" />, bg: "#1A52A0", label: "Enquiries", route: "/enquiries" },
  ...
  { icon: <BookOpen size={22} color="#FFFFFF" />, bg: "#1A52A0", label: "CPD", route: "/cpd" },
  ...
  { icon: <FolderOpen size={22} color="#FFFFFF" />, bg: "#1A52A0", label: "Documents", route: "/documents" },
  ...
  { icon: <Search size={22} color="#FFFFFF" />, bg: "#1A52A0", label: "Find gaps", route: "/gaps" },
  ...
  { icon: <BarChart2 size={22} color="#FFFFFF" />, bg: "#1A52A0", label: "Weekly report", route: "/weeklyreport" },
  ...
  { icon: <ToggleLeft size={22} color="#FFFFFF" />, bg: "#1A52A0", label: "Availability", route: "/availability" },
  ...
  { icon: <CalendarDays size={22} color="#FFFFFF" />, bg: "#1A52A0", label: "Diary", route: "/diary" },
  ...
  { icon: <CalendarDays size={22} color="#FFFFFF" />, bg: "#1A52A0", label: "Availability", route: "/quickavailability" },
  { icon: <RefreshCw size={22} color="#FFFFFF" />, bg: "#7C3AED", label: "Calendar sync", route: "/calendarsync" },
  { icon: <UserCircle size={22} color="#FFFFFF" />, bg: "#1A52A0", label: "Profile", route: "/profile" },
...
function QuickAccessPage() {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#F2F4F8", fontFamily: "Poppins, sans-serif" }}
    >
      {/* TOP BAR */}
      <div
        ...
        <div className="px-4 pt-3 pb-1">
          ...
          >
            ...
            <input
              ...
              className="flex-1 bg-transparent outline-none text-[14px] text-[#0F2044] placeholder-[#9CA3AF]"
              autoFocus
            />
            {searchQuery && (
              <button
        ...
        {filteredTiles.map((t) => (
          ...
          >
            ...
            <span
              ...
              style={{ color: "#0F2044", fontWeight: 500 }}
            >
              {t.label}
            </span>
          </button>
