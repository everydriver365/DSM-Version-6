...
const quickAccessTiles = [
  ...
  { icon: <IconChartBar size={22} color="#FFFFFF" />, bg: "#1877D6", label: "Weekly report", route: "/weekly-report" },
  ...
  { icon: <IconSun size={22} color="#FFFFFF" />, bg: "#0B1F3A", label: "EOD", route: "/end-of-day" },
