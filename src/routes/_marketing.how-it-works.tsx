...
function HowItWorksPage() {
  return (
    <div style={{ fontFamily: "Poppins, sans-serif" }}>
      ...
      {/* For instructors */}
      <section className="bg-white py-20 px-6" style={{ fontFamily: "Poppins, sans-serif" }}>
        <div className="max-w-[1180px] mx-auto">
      ...
      {/* For learners */}
      <section className="bg-[#F7FAFC] py-20 px-6" style={{ fontFamily: "Poppins, sans-serif" }}>
        <div className="max-w-[1180px] mx-auto">
      ...
      <section className="bg-[#133155] py-20 px-6" style={{ fontFamily: "Poppins, sans-serif" }}>
        <div className="max-w-[1180px] mx-auto">
      ...
      {/* FAQ */}
      <section className="bg-white py-16 px-6" style={{ fontFamily: "Poppins, sans-serif" }}>
        <div className="max-w-[1180px] mx-auto">
      ...
      {/* Bottom CTA */}
      <section className="bg-[#1877D6] py-16 px-6 text-center" style={{ fontFamily: "Poppins, sans-serif" }}>
        <div className="max-w-[1180px] mx-auto">
