...
const THEMES: { key: Theme; label: string; swatch: string[] }[] = [
  { key: "classic", label: "Classic", swatch: ["#0A2540", "#0B7DDA", "#FFFFFF"] },
...
function MiniSitePage() {
  ...
  const [brandColour, setBrandColour] = useState<string>("#0B7DDA");
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ ...POPPINS, backgroundColor: "#F7F5EF" }}>
        <Loader2 className="animate-spin" color="#0B7DDA" />
      </div>
    );
  }
      ...
      <div className="px-4 pt-4">
        ...
        >
          ...
          <div className="flex items-center justify-between gap-2 mb-3">
            <div className="text-[14px] truncate" style={{ color: "#0B7DDA" }}>{displayUrl}</div>
            <button
              onClick={copyUrl}
              aria-label="Copy URL"
              style={{ background: "none", border: "none", cursor: "pointer", color: "#0B7DDA", display: "flex" }}
            >
              <Copy size={18} />
            </button>
          </div>
        ...
        {!originalSlug && (
          <Card className="mb-3" style={{ background: "#fff" }}>
            ...
            <div className="text-[12px] mt-2" style={{ color: "#6B7280" }}>
              {SITE_BASE}<span style={{ color: "#0B7DDA", fontWeight: 600 }}>{slug || "your-slug"}</span>
            </div>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    borderColor: selected ? "#0B7DDA" : "#EEF2F7",
