...
function typeMeta(t: string | null) {
  switch (t) {
    case "adi_badge":
      return { color: "#1A4A6E", tint: "#EEF4FB", Icon: BadgeCheck, label: "ADI Badge" };
    case "dbs":
    ...
    case "insurance":
      return { color: "#1A4A6E", tint: "#EEF4FB", Icon: FileText, label: "Insurance" };
    default:
