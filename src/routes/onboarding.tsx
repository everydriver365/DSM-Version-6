...
function OnboardingPage() {
  ...
  return (
    <div
      className="min-h-screen w-full bg-[#0A2540] flex flex-col items-center px-4 py-8"
      style={POPPINS}
    >
      {/* Progress */}
      ...
      >
        {step === 1 && (
          <div className="flex flex-col items-center gap-4">
            ...
            <h1 className="text-[24px] font-semibold text-[#0A2540] text-center">Welcome to DSM</h1>
        ...
        {step === 2 && (
          <div className="flex flex-col gap-4">
            <h2 className="text-[20px] font-semibold text-[#0A2540]">Tell us about yourself</h2>
        ...
        {step === 3 && (
          <div className="flex flex-col gap-4">
            <h2 className="text-[20px] font-semibold text-[#0A2540]">Your teaching vehicle</h2>
        ...
        {step === 4 && (
          <div className="flex flex-col gap-3">
            <h2 className="text-[20px] font-semibold text-[#0A2540]">When do you work?</h2>
            <div className="flex flex-col gap-2">
              {DAYS.map(({ key, label }) => {
                ...
                return (
                  ...
                  >
                    <label className="flex items-center gap-2 w-[110px] text-[13px] text-[#0A2540] cursor-pointer">
                      <input
                        type="checkbox"
                        checked={h.enabled}
                        onChange={(e) =>
                    ...
                    <input
                      ...
                      className="flex-1 h-9 rounded-md px-2 text-[13px] text-[#0A2540] bg-white disabled:opacity-40"
        ...
        {step === 5 && (
          <div className="flex flex-col gap-4">
            <h2 className="text-[24px] font-bold text-[#0A2540]">Want a free website?</h2>
            ...
            {websiteChoice === "yes" && (
              <div className="pl-2 -mt-2 flex flex-col gap-2">
                <label className="flex items-start gap-2 text-[13px] text-[#0A2540] cursor-pointer">
                  <input
                    type="checkbox"
        ...
        {step === 6 && (
          <div className="flex flex-col items-center gap-4">
            ...
            <h2 className="text-[24px] font-semibold text-[#0A2540] text-center">You&apos;re all set!</h2>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        <div className="text-[14px] font-semibold text-[#0A2540]">{title}</div>
