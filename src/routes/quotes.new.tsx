...
export const Route = createFileRoute("/quotes/new")({
  validateSearch: (search: Record<string, unknown>): { name?: string; email?: string; phone?: string; course?: string; courseType?: string; hours?: string; price?: string; message?: string } => ({
