...
function SchedulePage() {
  ...
  const fetchCalendarBlocks = useCallback(async () => {
    ...
    const SUPABASE_ANON_KEY =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmSiLCJyZWYiOiJiaW5xZmZyaWh3amNxcHJtb3FmcyIsInJvbGUiOiJhbm9uIiwiaWF0IjoxNzgxNDc0ODIxLCJleHAiOjIwOTcwNTA4MjF9.HKlgx3dxP3uxX9wMRRUnfb0IPwaBpFcut_iUgT5XFeo";
    try {
