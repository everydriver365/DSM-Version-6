...
function AboutPage() {
  return (
    <div style={{ fontFamily: "Poppins, sans-serif" }}>
      ...
      {/* Mission section */}
      <section className="bg-[#F7FAFC] py-20 px-6 text-center" style={{ fontFamily: "Poppins, sans-serif" }}>
        <div className="max-w-[1180px] mx-auto">
      ...
      {/* Contact teaser */}
      <section className="bg-[#F7FAFC] py-16 px-6 text-center" style={{ fontFamily: "Poppins, sans-serif" }}>
        <div className="max-w-[1180px] mx-auto">
