      ...
      {lesson && dateObj && (
        <>
          ...
          {lessonInsight && (() => {
            ...
            return (
              <div className="mx-4 mt-3" style={{ position: 'relative', background: '#FFFFFF', border: `0.5px solid ${BORDER}`, borderRadius: 10, padding: '13px 16px 13px 19px', display: 'flex', alignItems: 'center', gap: 12, fontFamily: "Inter, sans-serif" }}>
                ...
                {lessonInsight.onAction && (
                  <button type="button" onClick={lessonInsight.onAction} style={{ background: '#F1F5F9', color: NAVY, border: 'none', borderRadius: 9, padding: '8px 13px', fontSize: 12, fontWeight: 500, cursor: 'pointer', fontFamily: "Inter, sans-serif", flexShrink: 0 }}>{lessonInsight.actionLabel}</button>
                )}
              </div>
            );
          })()}
