  ...
  return (
    <div className="min-h-screen bg-white pb-12" style={POPPINS}>
      ...
      <div className="px-4 mt-3 flex items-center justify-between">
        ...
        >
          <ChevronLeft size={18} color="#0B1F3A" />
        </button>
        ...
        <button
          ...
          style={{ width: 36, height: 36, borderRadius: 8, backgroundColor: "#F3F4F6" }}
        >
          <ChevronRight size={18} color="#0B1F3A" />
        </button>
      </div>
              ...
              <div key={i}>
                ...
                <div className="flex items-center" style={{ gap: 12 }}>
                  ...
                  <div className="flex-1">
                    <div className="text-[14px] font-medium text-[#0B1F3A]">{p.name}</div>
          ...
          {days.map((d, i) => {
            ...
            return (
              <div key={i}>
                ...
                >
                  <div className="text-[14px] font-medium text-[#0B1F3A]" style={{ width: 56 }}>
                    {d.label}
                  </div>
...
function BreakdownRow({ label, count, color }: { label: string; count: number; color: string }) {
  return (
    <div className="flex items-center justify-between">
      ...
      <span className="text-[14px] font-semibold text-[#0B1F3A]">{count}</span>
    </div>
  );
}
