...
function HomePage() {
  ...
  const quickAccessTiles = [
    { icon: <span style={{ fontSize: 24 }}>📅</span>, bg: "#1877D6", label: "Schedule", route: "/schedule" },
    { icon: <span style={{ fontSize: 24 }}>📊</span>, bg: "#1877D6", label: "MTD", route: "/month-to-date" },
    { icon: <span style={{ fontSize: 24 }}>🗺️</span>, bg: "#16A34A", label: "Start tracking", route: "/live" },
    { icon: <span style={{ fontSize: 24 }}>✅</span>, bg: "#7C3AED", label: "Month end", route: "/monthend" },
    { icon: <span style={{ fontSize: 24 }}>👥</span>, bg: "#16A34A", label: "Pupils", route: "/pupils" },
    { icon: <span style={{ fontSize: 24 }}>💷</span>, bg: "#7C3AED", label: "Payments", route: "/payments" },
    { icon: <span style={{ fontSize: 24 }}>💬</span>, bg: "#1877D6", label: "Messages", route: "/messages" },
    { icon: <span style={{ fontSize: 24 }}>📈</span>, bg: "#16A34A", label: "Earnings", route: "/earnings" },
    { icon: <span style={{ fontSize: 24 }}>🧾</span>, bg: "#D97706", label: "Expenses", route: "/expenses" },
    { icon: <span style={{ fontSize: 24 }}>🚗</span>, bg: "#DC2626", label: "Mileage", route: "/mileage" },
    { icon: <span style={{ fontSize: 24 }}>⛽</span>, bg: "#D97706", label: "Fuel costs", route: "/fuel" },
    { icon: <span style={{ fontSize: 24 }}>📉</span>, bg: "#1877D6", label: "Reports", route: "/reports" },
    { icon: <span style={{ fontSize: 24 }}>📈</span>, bg: "#7C3AED", label: "Performance", route: "/performance" },
    { icon: <span style={{ fontSize: 24 }}>🎓</span>, bg: "#16A34A", label: "Tests", route: "/tests" },
    { icon: <span style={{ fontSize: 24 }}>📝</span>, bg: "#F59E0B", label: "Test day", route: "/testday" },
    { icon: <span style={{ fontSize: 24 }}>🏆</span>, bg: "#F59E0B", label: "Rewards", route: "/rewards" },
    { icon: <span style={{ fontSize: 24 }}>📚</span>, bg: "#DC2626", label: "Courses", route: "/courses" },
    { icon: <span style={{ fontSize: 24 }}>⭐</span>, bg: "#D97706", label: "Reviews", route: "/reviews" },
    { icon: <span style={{ fontSize: 24 }}>📥</span>, bg: "#1877D6", label: "Enquiries", route: "/enquiries" },
    { icon: <span style={{ fontSize: 24 }}>⏰</span>, bg: "#DC2626", label: "Waiting list", route: "/waitlist" },
    { icon: <span style={{ fontSize: 24 }}>🎁</span>, bg: "#16A34A", label: "Referrals", route: "/referrals" },
    { icon: <span style={{ fontSize: 24 }}>🚙</span>, bg: "#6B7280", label: "Vehicle", route: "/vehicle" },
    { icon: <span style={{ fontSize: 24 }}>📖</span>, bg: "#1877D6", label: "CPD", route: "/cpd" },
    { icon: <span style={{ fontSize: 24 }}>📗</span>, bg: "#7C3AED", label: "CPD log", route: "/cpd" },
    { icon: <span style={{ fontSize: 24 }}>📋</span>, bg: "#7C3AED", label: "Standards", route: "/standards" },
    { icon: <span style={{ fontSize: 24 }}>🧮</span>, bg: "#D97706", label: "Tax", route: "/tax" },
    { icon: <span style={{ fontSize: 24 }}>📄</span>, bg: "#16A34A", label: "Tax report", route: "/tax-report" },
    { icon: <span style={{ fontSize: 24 }}>☑️</span>, bg: "#7C3AED", label: "Todos", route: "/todos" },
    { icon: <span style={{ fontSize: 24 }}>🗒️</span>, bg: "#D97706", label: "Notes", route: "/notes" },
    { icon: <span style={{ fontSize: 24 }}>📁</span>, bg: "#1877D6", label: "Documents", route: "/documents" },
    { icon: <span style={{ fontSize: 24 }}>📜</span>, bg: "#7C3AED", label: "Manifest", route: "/manifest" },
    { icon: <span style={{ fontSize: 24 }}>✅</span>, bg: "#16A34A", label: "Checklist", route: "/checklist" },
    { icon: <span style={{ fontSize: 24 }}>🔔</span>, bg: "#DC2626", label: "Reminders", route: "/reminder" },
    { icon: <span style={{ fontSize: 24 }}>❤️</span>, bg: "#D97706", label: "Health", route: "/health" },
    { icon: <span style={{ fontSize: 24 }}>📚</span>, bg: "#16A34A", label: "Resources", route: "/resources" },
    { icon: <span style={{ fontSize: 24 }}>❓</span>, bg: "#6B7280", label: "Help", route: "/help" },
    { icon: <span style={{ fontSize: 24 }}>🧩</span>, bg: "#7C3AED", label: "Pipeline", route: "/pipeline" },
    { icon: <span style={{ fontSize: 24 }}>✍️</span>, bg: "#6B7280", label: "Waivers", route: "/waivers" },
    { icon: <span style={{ fontSize: 24 }}>🔍</span>, bg: "#1877D6", label: "Find gaps", route: "/gaps" },
    { icon: <span style={{ fontSize: 24 }}>👥</span>, bg: "#DC2626", label: "Bulk message", route: "/bulkmessage" },
    { icon: <span style={{ fontSize: 24 }}>🧭</span>, bg: "#16A34A", label: "Sat Nav", route: "/satnav" },
    { icon: <span style={{ fontSize: 24 }}>📊</span>, bg: "#1877D6", label: "Weekly report", route: "/weekly-report" },
    { icon: <span style={{ fontSize: 24 }}>📍</span>, bg: "#DC2626", label: "Locations", route: "/locations" },
    { icon: <span style={{ fontSize: 24 }}>⬆️</span>, bg: "#6B7280", label: "Import", route: "/dataimport" },
    { icon: <span style={{ fontSize: 24 }}>🏅</span>, bg: "#D97706", label: "Certifications", route: "/certifications" },
    { icon: <span style={{ fontSize: 24 }}>🔄</span>, bg: "#1877D6", label: "Availability", route: "/availability" },
    { icon: <span style={{ fontSize: 24 }}>☀️</span>, bg: "#D97706", label: "EOD", route: "/eod" },
    { icon: <span style={{ fontSize: 24 }}>🌙</span>, bg: "#1877D6", label: "End of day", route: "/end-of-day" },
    { icon: <span style={{ fontSize: 24 }}>📢</span>, bg: "#DC2626", label: "Broadcast", route: "/broadcast" },
    { icon: <span style={{ fontSize: 24 }}>⚡</span>, bg: "#7C3AED", label: "Automations", route: "/automations" },
    { icon: <span style={{ fontSize: 24 }}>📆</span>, bg: "#1877D6", label: "Diary", route: "/diary" },
    { icon: <span style={{ fontSize: 24 }}>👑</span>, bg: "#7C3AED", label: "My plan", route: "/subscription" },
    { icon: <span style={{ fontSize: 24 }}>▶️</span>, bg: "#DC2626", label: "Live session", route: "/livesession" },
    { icon: <span style={{ fontSize: 24 }}>🔍</span>, bg: "#6B7280", label: "Search", route: "/search" },
    { icon: <span style={{ fontSize: 24 }}>🔔</span>, bg: "#DC2626", label: "Notifications", route: "/notifications" },
    { icon: <span style={{ fontSize: 24 }}>🔄</span>, bg: "#1877D6", label: "Availability", route: "/quickavailability" },
    { icon: <span style={{ fontSize: 24 }}>🔄</span>, bg: "#7C3AED", label: "Calendar sync", route: "/calendarsync" },
    { icon: <span style={{ fontSize: 24 }}>👤</span>, bg: "#1877D6", label: "Profile", route: "/profile" },
    { icon: <span style={{ fontSize: 24 }}>📊</span>, bg: "#D97706", label: "MTD", route: "/mtd" },
    { icon: <span style={{ fontSize: 24 }}>📝</span>, bg: "#D97706", label: "Quotes", route: "/quotes" },
    { icon: <span style={{ fontSize: 24 }}>🌅</span>, bg: "#16A34A", label: "Briefing", route: "/briefing" },
    { icon: <span style={{ fontSize: 24 }}>⚠️</span>, bg: "#DC2626", label: "Outstanding", route: "/outstanding" },
    { icon: <span style={{ fontSize: 24 }}>🌐</span>, bg: "#1877D6", label: "My website", route: "/minisite" },
