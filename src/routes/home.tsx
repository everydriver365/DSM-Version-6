          ...
          <div style={{ fontFamily: PF, padding: '14px 16px 0' }}>
            ...
            {(() => {
              ...
              const quickTiles: QuickTile[] = [
                ...
                { label: 'Payments', sub: 'Outstanding', route: '/payments', icon: IconCurrencyPound, iconStroke: '#1E8E3E', chipBg: '#DDEFE1', attention: outstanding > 0, badge: outstanding > 0 ? Math.round(outstanding) : undefined },
