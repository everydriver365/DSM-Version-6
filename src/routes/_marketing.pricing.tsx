  ...
  return (
    <>
      ...
      <Section padY={24}>
        ...
        >
          <div style={{ fontSize: 12, fontWeight: 600, color: "#0B69AD", letterSpacing: "0.12em", textTransform: "uppercase" }}>
            DSM Professional
          </div>
      ...
      <Section padY={64}>
        <div style={{ textAlign: "center" }}>
          ...
          <Link to="/contact" style={{ color: "#0B69AD", fontWeight: 600, textDecoration: "none" }}>
            Get in touch →
          </Link>
        </div>
      </Section>
