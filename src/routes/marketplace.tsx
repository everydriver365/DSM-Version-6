...
const marketplaceItems: MarketplaceItem[] = [
  ...
  },
  {
    ...
    gradient: "linear-gradient(135deg, #1877D6, #7A1419)",
    icon: Camera,
    iconColor: "#60A5FA",
    badge: null,
    badgeBg: "#FFFFFF",
  ...
  },
  {
    ...
    gradient: "linear-gradient(135deg, #1877D6, #14532D)",
    icon: Heart,
    iconColor: "#34D399",
    badge: "POPULAR",
    badgeBg: "#10B981",
  ...
  },
  {
    ...
    gradient: "linear-gradient(135deg, #1877D6, #4C1D95)",
    icon: Activity,
    iconColor: "#F97316",
    badge: null,
    badgeBg: "#FFFFFF",
  ...
  },
  {
    ...
    gradient: "linear-gradient(135deg, #0B1F3A, #0B1F3A)",
    icon: GraduationCap,
    iconColor: "#FBBF24",
    badge: null,
    badgeBg: "#FFFFFF",
