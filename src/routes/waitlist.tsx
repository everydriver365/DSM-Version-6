        ...
        <div>
          {waiting === null ? (
            ...
            <div className="p-10 text-center" style={POPPINS}>
              ...
              <div className="text-[14px] font-semibold text-[#0F2044]">No pupils waiting</div>
        ...
        <div>
          {offers === null ? (
            ...
            <div className="p-10 text-center" style={POPPINS}>
              ...
              <div className="text-[14px] font-semibold text-[#0F2044]">No slot offers yet</div>
              <div className="text-[12px] mt-1" style={{ color: GREY }}>
              ...
              filtered.map((p) => (
                <button
                  ...
                  style={{
                    ...
                    color: pupilId === p.id ? BLUE : "#0F2044",
