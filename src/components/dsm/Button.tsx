...
export function Button({
  ...
  const base =
    "cf-tap h-11 rounded-lg font-semibold text-[14px] transition-colors disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center justify-center px-5";
