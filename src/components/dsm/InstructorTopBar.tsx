...
/* Real rendered bar height: top padding (safe area + 6) + 84px logo + 4px bottom padding. */
export const TOP_BAR_SPACER = "calc(max(env(safe-area-inset-top, 0px), 24px) + 94px)";
