...
const WELLBEING: LearnItem[] = [
  ...
  },
  {
    ...
    steps: [
      "Before you drive home, log the day's notes and payments — then close EDP.",
...
export const HEALTH_DISCLAIMER =
  "General wellbeing information only — EDP is not a medical service. Speak to your GP or NHS 111 about health concerns.";
