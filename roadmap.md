...
- [x] Pass real recurring blocks and time off to computeDayGaps in home.tsx
...
- [x] Add "Report alert" (road closure etc) to the home FAB
- [x] Next lesson tile: navigate arrow next to test centre name when the next item is a test
